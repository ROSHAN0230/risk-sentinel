...
class RazorpayLiveService:
    ...
    def process_checkout_payment(self, request: ProcessCheckoutRequest) -> Dict[str, Any]:
        ...
        tx_rec = TransactionRecord(
            ...
            integrity_hash=integrity_hash,
            sender_pre_balance=float(combined_notes.get("oldbalanceOrg", 0.0)) if "oldbalanceOrg" in combined_notes else None,
            dest_pre_balance=float(combined_notes.get("oldbalanceDest", 0.0)) if "oldbalanceDest" in combined_notes else None,
